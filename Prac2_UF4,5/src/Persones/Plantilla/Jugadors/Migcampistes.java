...
public class Migcampistes extends Jugadors {
    ...
    private int assisGol;
    private int balonsRec;

    public Migcampistes(String dNI, String nom, String cognom, String dataNaixament, String correu, int telefon,
            int numSerguretatSocial, double souBase, boolean titular, int assisGol, int balonsRec) {
        super(dNI, nom, cognom, dataNaixament, correu, telefon, numSerguretatSocial, souBase, titular);
        this.assisGol = assisGol;
    ...
    public int getAssisGol() {
        return assisGol;
    }

    public void setAssisGol(int assisGol) {
        this.assisGol = assisGol;
    }
    ...
    protected double calculSou(double souBase) {
        ...
        double sou = souBase + (assisGol * 100) + (balonsRec * 50);
    ...
    public void alta(int tamanyArray) {
        ...
        System.out.print("\n Atacs Aturats: ");
        int assisGol = teclat.nextInt();
        this.setAssisGol(assisGol);
    ...
    public void modificar() {
        ...
        System.out.println("Vols modificar el assistencies de gol?(s/n)");
        opcio = teclat.next();
